...
function displayCategories(categories) {
  ...
  categories.forEach(category => {
      ...
      if (category.name === 'Action') {
        document.querySelector('.link-pages').innerHTML = 
        `<a href="./game-categories-pages/action.html" class="btn btn-outline-light link-pages">View Games</a>`
      }
  });
}
